...
namespace YinLunTestBench
{
    public partial class AirKeepQuery : Form
    {
        ...
        private void DG_DataBase_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //LB_Pre5.Text = ((float)m_yMax).ToString("0.0") + "MPa";
            //LB_Pre4.Text = ((float)(m_yMax * 3 / 4)).ToString("0.0") + "MPa";
            //LB_Pre3.Text = ((float)(m_yMax * 2 / 4)).ToString("0.0") + "MPa";
            //LB_Pre2.Text = ((float)(m_yMax * 1 / 4)).ToString("0.0") + "MPa";
            //LB_Pre1.Text = ((float)(m_yMax * 0 / 4)).ToString("0.0") + "MPa";
